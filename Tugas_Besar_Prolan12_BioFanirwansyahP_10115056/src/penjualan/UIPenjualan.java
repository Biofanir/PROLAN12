...
public class UIPenjualan extends javax.swing.JFrame {
    ...
    private void fillComboBarang(){
        ModelBarang barang1 = new ModelBarang("Xerus", " ", 1300);
        ModelBarang barang2 = new ModelBarang("Golden Shield", " ", 1600);
        ModelBarang barang3 = new ModelBarang("Damascus", " ", 3500);
        ModelBarang barang4 = new ModelBarang("Eye of Sword", " ", 2000);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pembelian Item Game");

        jLabel2.setText("Barang");

        cboBarang.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
